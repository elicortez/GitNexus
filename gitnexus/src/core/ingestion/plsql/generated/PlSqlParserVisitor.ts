...
export default class PlSqlParserVisitor<Result> extends ParseTreeVisitor<Result> {
   ...
   * @return the visitor result
   */
  visitExternal_table_date_format_clause?: (
   ...
   * @return the visitor result
   */
  visitExternal_table_hive_parameter_map?: (
    ctx: External_table_hive_parameter_mapContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitExternal_table_hive_parameter_map_entry?: (
